    ...
    fn from(value: String) -> Self {
        match value.as_str() {
            ...
            "gemini-2.0-flash-thinking-exp-01-21" => {
                LlmModel::Gemini(GeminiModel::Gemini20FlashThinkingExp0121)
            }
            ...
            "DeepSeek-R1" => LlmModel::Azure(AzureModel::DeepseekR1),
            "gpt-4o-mini" => LlmModel::Azure(AzureModel::Gpt4oMini),
...
impl From<LlmModel> for String {
    fn from(value: LlmModel) -> Self {
        match value {
            ...
            LlmModel::Azure(model) => match model {
                AzureModel::DeepseekR1 => "DeepSeek-R1",
                AzureModel::Gpt4oMini => "gpt-4o-mini",
            },
        }
        .to_string()
    }

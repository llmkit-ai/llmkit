...
use middleware::auth::{self, admin_auth_middleware, user_auth_middleware};
...
use controllers::{
    ...
    users::{
        approve_user, delete_user, get_current_user, get_user, list_pending_users, list_users, login, 
        register, reject_user, update_password, update_registration_state, update_role, update_user,
    },
};

...
INSERT INTO provider (name, base_url) VALUES ('gemini', 'https://generativelanguage.geminiapis.com/v1');
INSERT INTO provider (name, base_url) VALUES ('deepseek', 'https://api.deepseek.com/v1');
INSERT INTO provider (name, base_url) VALUES ('azure', 'https://grokingai8727375833.services.ai.azure.com/models/chat/completions?api-version=2024-05-01-preview');
...
INSERT INTO model (provider_id, name, supports_json, supports_tools)
SELECT id, 'gemini-2.0-flash-001', 1, 1 FROM provider WHERE name = 'gemini';

INSERT INTO model (provider_id, name, supports_json, supports_tools)
SELECT id, 'gemini-2.0-flash-lite-preview-02-05', 1, 1 FROM provider WHERE name = 'gemini';

INSERT INTO model (provider_id, name, supports_json, supports_tools)
SELECT id, 'gemini-2.0-flash-thinking-exp-01-21', 1, 0 FROM provider WHERE name = 'gemini';

INSERT INTO model (provider_id, name, supports_json, supports_tools)
SELECT id, 'gemini-2.0-pro-exp-02-05', 1, 1 FROM provider WHERE name = 'gemini';

INSERT INTO model (provider_id, name, supports_json, supports_tools)
SELECT id, 'gemini-1.5-flash', 1, 1 FROM provider WHERE name = 'gemini';

INSERT INTO model (provider_id, name, supports_json, supports_tools)
SELECT id, 'gemini-1.5-flash-8b', 1, 1 FROM provider WHERE name = 'gemini';

INSERT INTO model (provider_id, name, supports_json, supports_tools)
SELECT id, 'gemini-1.5-pro', 1, 1 FROM provider WHERE name = 'gemini';

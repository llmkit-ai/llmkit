...
const typeClasses = {
  ...
  'primary': 'border-black bg-black text-neutral-900 dark:text-neutral-900 hover:text-neutral-100 hover:bg-neutral-800 dark:border-white dark:bg-white dark:text-black dark:hover:bg-neutral-200',
